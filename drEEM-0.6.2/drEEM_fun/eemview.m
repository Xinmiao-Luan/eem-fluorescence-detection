...
%   <strong>eemview</strong>(datasource,datafield,varargin)
%   <strong>eemview</strong>(datasource,datafield,plotlayout,istart,plotview,datalabel,axeslimits,rotate,colorbar,ncontours,plotsize)
%
% <a href="matlab: doc eemview">help for eemview</a> <- click on the link
...
%               'wavenum': plots have wavenumbers on the x axis
%
%    colorbar: (optional) 
%                     []: no colorbar
...
if bigplot
    ...
    hf=dreemfig;
    set(hf,'Position',[scrsz(3)/4 scrsz(4)/4 scrsz(3)/1.5 scrsz(4)/1.5]);
else
    hf=dreemfig;
end
